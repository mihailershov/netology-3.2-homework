...
<p>Основное отличие интерфейса от абстракного класса - интерфейс может содержать в себе только описание методов (названия, если угодно), sабстрактный класс может содержать как описание методов, <b>так и их реализацию</b>. В абстрактном классе можно указывать свойства, в интерфейсе - <b>нельзя</b>. Можно сделать множественный implement интерфейсов, а множественный extends абстрактных классов сделать <b>нельзя</b>.</p>
<p>Если рассматривать ситуацию, когда мы выбираем, в чем хранить описание методов - в интерфейсе или в абстрактном классе, то тут мы должны вспомнить один из принципов SOLID - interface segregation (разделение интерфейсов). Это значит, что всегда надо стараться разделять описание методов по контексту и "распихивать" по интерфейсам, а потом уже делать множественный implement. Да, и тут мы вспоминаем, что множественное наследование не поддерживается для классов, поэтому мы просто не сможем соблюдать принцип разделение интерфейсов, используя абстрактные классы для хранения описания методов, соответственно, используем интерфейсы в этом случае. Ну а абстрактные классы используем, когда надо именно описать некую сущность, то есть, включить не только методы, но и свойства. Методы могут быть и определенные внутри абстрактного класса, и наследуемые от интерфейса (хотя лучше предусмотреть все методы в интерфейсе, чтобы было меньше шансов допустить ошибку).</p>
</body>
